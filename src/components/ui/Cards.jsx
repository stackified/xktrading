  ...
  return (
    <div className="card overflow-hidden">
      ...
      <div className="card-body">
        ...
        <button className="btn btn-primary mt-3" onClick={() => onView?.(event)}>Details</button>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="card h-full">
      <div className="card-body">
        ...
        <button className="btn btn-secondary mt-3" onClick={() => onView?.(post)}>Read</button>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="card h-full">
      <div className="card-body">
        ...
        <div className="text-sm text-gray-400 mb-3 line-clamp-2">{company.details}</div>
        <div className="flex items-center justify-between">
          <span className="text-sm">⭐ {company.ratingsAggregate.toFixed(1)}</span>
          <button className="btn btn-primary" onClick={() => onView?.(company)}>View</button>
        </div>
      </div>
    </div>
  );
    ...
    <div className="card h-full overflow-hidden">
      ...
      <div className="card-body">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          <button className="btn btn-primary" onClick={() => onView?.(product)}>Details</button>
        </div>
      </div>
    </div>
  );
      ...
      {locked && (
        <div className="absolute inset-0 backdrop-blur-sm bg-black/40 flex items-center justify-center">
          <div className="text-center">
            <div className="mb-2 text-sm text-gray-200">Register to access this content</div>
            {cta}
          </div>
        </div>
      )}
